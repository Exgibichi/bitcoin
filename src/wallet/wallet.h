...
#ifndef STATUSQUO_WALLET_WALLET_H
#define STATUSQUO_WALLET_WALLET_H
...
public:
     ...
     * on this statusquo node, and set to 0 for transactions that were created
...
#endif // STATUSQUO_WALLET_WALLET_H
