...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.sq.petertodd.org", true); // Peter Todd, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.statusquo.jonasschnelli.ch", true);
        vSeeds.emplace_back("seed.tsq.petertodd.org", true);
        vSeeds.emplace_back("testnet-seed.bluematt.me", false);
        vSeeds.emplace_back("testnet-seed.statusquo.schildbach.de", false);
