...
{
    BOOST_CHECK(TestSplitHost("www.statusquo.cash", "www.statusquo.cash", -1));
    BOOST_CHECK(TestSplitHost("[www.statusquo.cash]", "www.statusquo.cash", -1));
    BOOST_CHECK(TestSplitHost("www.statusquo.cash:80", "www.statusquo.cash", 80));
    BOOST_CHECK(TestSplitHost("[www.statusquo.cash]:80", "www.statusquo.cash", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6232", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6232", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6232", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:6232", "::", 8333));
    BOOST_CHECK(TestSplitHost("::6232", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":6232", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:6232", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6232", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6232", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
