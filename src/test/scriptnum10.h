...
#ifndef STATUSQUO_TEST_SCRIPTNUM10_H
#define STATUSQUO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Statusquo Core 0.10.0, for cross-comparison.
 */
public:
