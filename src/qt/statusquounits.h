...
#ifndef STATUSQUO_QT_STATUSQUOUNITS_H
#define STATUSQUO_QT_STATUSQUOUNITS_H
...
/** Statusquo unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StatusquoUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StatusquoUnits(QObject *parent);

    /** Statusquo units.
      @note Source: https://en.statusquo.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SQ,
...
typedef StatusquoUnits::Unit StatusquoUnit;

#endif // STATUSQUO_QT_STATUSQUOUNITS_H
