 ...
 * between statusquod, and statusquo-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("statusquo-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), STATUSQUO_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/statusquo/statusquo>";
    const std::string URL_WEBSITE = "<https://statusquocore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("statusquo-loadblk");
...
/** Sanity checks
 *  Ensure that Statusquo is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Statusquo process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", STATUSQUO_CONF_FILENAME)).string());
