...
#if defined(NDEBUG)
# error "Statusquo cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Statusquo Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SQ additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("statusquo-scriptch");
