...
###   statusquo.cash and statusquo.cash and compares them.
...
RCSUBDIR="test"
HOST1="https://statusquo.cash"
HOST2="https://statusquo.cash"
BASEDIR="/bin/"
...
if [ $? -ne 0 ]; then
   echo "statusquo.cash failed to provide signature file, but statusquo.cash did?"
   echo "wget output:"
   echo "$WGETOUT"|sed 's/^/\t/g'
...
if [ "$SIGFILEDIFFS" != "" ]; then
   echo "statusquo.cash and statusquo.cash signature files were not equal?"
