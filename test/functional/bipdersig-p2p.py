...
class BIP66Test(StatusquoTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # statusquod is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and statusquod produces more specific reject
            # reasons.
