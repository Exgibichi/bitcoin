...
from test_framework.test_framework import StatusquoTestFramework, STATUSQUOD_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(StatusquoTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid statusquo address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.statusquod_processes[1].wait(timeout=STATUSQUOD_PROC_WAIT_TIMEOUT)
