...
class WalletTest(StatusquoTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SQ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 sq in block rewards plus fees, but
        ...
        # Send 10 SQ with subtract fee from amount
        ...
        # Sendmany 10 SQ with subtract fee from amount
