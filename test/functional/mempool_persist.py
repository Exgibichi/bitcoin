...
By default, statusquod will dump mempool on shutdown and
...
class MempoolPersistTest(StatusquoTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give statusquod a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent statusquod from writing mempool.dat to disk. Verify that `savemempool` fails")
