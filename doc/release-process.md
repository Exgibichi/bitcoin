...
space *do not upload these to the statusquo.cash server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the statusquo.cash server
...
people without access to `statusquo.cash` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
statusquo.cash (see below for statusquo.cash update instructions).

- Update statusquo.cash version

  - First, check to see if the statusquo.cash maintainers have prepared a
    release: https://github.com/statusquo-dot-org/statusquo.cash/labels/Releases

      - If they have, it will have previously failed their Travis CI
        checks because the final release files weren't uploaded.
        Trigger a Travis CI rebuild---if it passes, merge.

  - If they have not prepared a release, follow the statusquo.cash release
    instructions: https://github.com/statusquo-dot-org/statusquo.cash#release-notes
