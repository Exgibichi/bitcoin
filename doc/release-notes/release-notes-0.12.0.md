...
notes of v0.11.0](https://github.com/Exgibichi/bitcoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).
...
Then, to tunnel a SSL connection on 26121 to a RPC server bound on localhost on port 18332 do:

    stunnel -d 26121 -r 127.0.0.1:18332 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:6121/
        ProxyPassReverse http://127.0.0.1:6121/
...
- #7209 `f3ad812` test: don't override STATUSQUOD and STATUSQUOCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add STATUSQUOD_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "SQ" (Ross Nicoll)
