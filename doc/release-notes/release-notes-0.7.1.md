...
source-only tarballs/zipballs directly from there:
  https://github.com/Exgibichi/bitcoin/tarball/v0.7.1  # .tar.gz
  https://github.com/Exgibichi/bitcoin/zipball/v0.7.1  # .zip
...
* When running -testnet, use RPC port 16121 by default.
