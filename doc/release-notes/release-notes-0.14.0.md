...
now ZMQ can be used on Windows. Please see [this document](https://github.com/Exgibichi/bitcoin/blob/master/doc/zmq.md) for
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/Exgibichi/bitcoin/pull/8753)
...
- #7562 `1eef038` Bump transaction version default to 2 (sqdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomsq)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomsq)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (sqdrak)
...
### Documentation
- #6121 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
