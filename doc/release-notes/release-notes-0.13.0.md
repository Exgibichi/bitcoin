...
randomly crashing on Windows XP. It is [not clear](https://github.com/Exgibichi/bitcoin/issues/7681#issuecomment-217439891)
...
[Pull request](https://github.com/Exgibichi/bitcoin/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/Exgibichi/bitcoin/pull/7762).
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use SQ/kB (MarcoFalke)
...
- #7692 `29b2be6` Remove P2P alert system (sqdrak)
...
- #8275 `042c323` Remove bad chain alert partition check (sqdrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (sqdrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (sqdrak)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (sqdrak)
...
- #7773 `7c80e72` Fix comments in tests (sqdrak)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (sqdrak)
