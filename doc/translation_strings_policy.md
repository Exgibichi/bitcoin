...
This document provides guidelines for internationalization of the Statusquo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `statusquo_en.ts` remains unchanged.
