...
unlocked to sign the Statusquo-Qt.app bundle.
...
allowing somebody to distribute a Statusquo-Qt.app or statusquo-qt-setup.exe with a valid
...
that the statusquo-qt.exe file inside the installer had not been tampered with.
